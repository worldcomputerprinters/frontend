...
// `icon` is the already-resolved fallback icon component, passed down by
// ProductGrid (which knows the full category list) — keeps this component
// simple and not responsible for looking up category data itself.
export default function ProductCard({ product, icon: Icon }) {
  ...
  return (
    <motion.div
      ...
      className="glass group flex flex-col overflow-hidden rounded-2xl transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)]"
    >
